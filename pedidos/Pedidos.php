<?php
	...
	$query = "SELECT * FROM PEDIDO"; //consulta_paginada($conexion, $query, 3, 3);
		...
		<form method="post" action="ControladorPedidos.php">
			...
			<div class="fila_empleado">
				...
				<div class="datos_empleado">
					...
					<input id="IDFAIDFTURA" name="OID_P"
				...
				<?php }	else { ?>
						...
						<div class="fila"><b><td><?php echo $fila["OID_P"]?> </td><td><?php echo $fila["FECHA"]?></td><td><?php echo $fila["PRECIO"]?></td>
